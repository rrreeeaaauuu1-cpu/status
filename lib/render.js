...
export const COORDS = {
  status: { x: 174, cy: 154, font: 38, maxW: 235 },
  state:  { x: 582, cy: 154, font: 38, maxW: 200 },
  damage: { x: 322, font: 38, maxW: 240, rows: [277, 327, 377, 427, 477] },
  inventory: { x: 788, font: 38, maxW: 212, rows: [219, 282, 345, 408, 471] },

  // 하단 FACTION(소속) 값 — 라벨 오른쪽
  faction: { x: 448, cy: 549, font: 38, maxW: 300 },

  // 캐릭터 실루엣 안쪽 출력% (노멀 배경 제외하고 표시)
  power: { x: 85, cy: 505, font: 400, maxW: 185, color: "#d10d0e" },
};
